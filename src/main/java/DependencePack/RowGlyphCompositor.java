...
public class RowGlyphCompositor extends Glyph {
    ...
    private List<Glyph> listGlyph;

    public RowGlyphCompositor() {
    }

    public void RowGlyphComposition(List<Glyph> listGlyph) {
        this.listGlyph = listGlyph;
    }

    public ArrayList<LinkedList<Canvas>> getListRow(double lengthRowApp){  //получение итоговой длины строки
