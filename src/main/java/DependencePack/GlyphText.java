...
public class GlyphText extends Glyph{
    ...
    protected Canvas getCanvasGlyph() {
        ...
        GraphicsContext gcTemp = canvasGlyph.getGraphicsContext2D();
        gcTemp.setFont(this.propertiesGlyph.getFontGlyph());
        gcTemp.fillText(this.propertiesGlyph.getValueTextGlyph(),
                0.0,
